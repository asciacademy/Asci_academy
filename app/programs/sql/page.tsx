...
export const metadata = {
  title: "SQL & Databases Course - Learn Relational SQL Simply | ASCI",
  description: "Master relational SQL, table JOINs, aggregations, indexing, and ACID transactions with interactive query sandboxes and execution plan visualizations.",
}

export default function SQLLandingPage() {
  const totalLessons = SQL_COURSE_PARTS.reduce(
      ...
      <section className="relative overflow-hidden py-16 lg:py-24 border-b border-border/80 bg-card">
        <div className="mx-auto max-w-5xl px-6 lg:px-8 text-center">
          ...
          <p className="mt-5 max-w-2xl mx-auto text-base sm:text-lg text-muted-foreground leading-relaxed">
            Understand how enterprise relational databases store, index, and query billions of records. Master SELECT queries, JOINs, B-Tree indexes, and ACID transactions.
          </p>

          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/programs/sql/course"
      ...
      <section className="py-16 lg:py-20 max-w-5xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-sm mt-2">
            Progress step-by-step from fundamental SELECT filters to advanced query optimization and transaction isolation.
          </p>
        </div>

        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {SQL_COURSE_PARTS.map((part, pIdx) => (
            <div
              key={part.id}
