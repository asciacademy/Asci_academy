...
export const metadata = {
  title: "HTML Course - Learn HTML5 Web Structure Simply | ASCI",
  description: "Learn HTML5 from scratch with simple explanations, live browser preview sandbox, and real elements. Zero setup required.",
}

export default function HTMLLandingPage() {
  const htmlParts = WEBDEV_COURSE_PARTS.filter((p) => p.id === "web-part-1")
  const totalLessons = htmlParts.reduce(
      ...
      <section className="relative overflow-hidden py-16 lg:py-24 border-b border-border/80 bg-card">
        <div className="mx-auto max-w-5xl px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 mb-6 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-mono font-medium shadow-2xs">
            ...
            <span>Web Structure Track • {totalLessons} Lessons</span>
          </div>
          ...
          <p className="mt-5 max-w-2xl mx-auto text-base sm:text-lg text-muted-foreground leading-relaxed">
            The foundation of every website on Earth. Learn headings, paragraphs, links, images, tables, and forms with live visual rendering in your browser.
          </p>
