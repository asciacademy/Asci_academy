...
export const metadata = {
  title: "JavaScript Course - Learn Modern JavaScript (ES6+) Simply | ASCI",
  description: "Learn modern JavaScript from scratch with simple explanations, functions, arrow syntax, events, and DOM manipulation. Zero setup required.",
}

export default function JavaScriptLandingPage() {
  const jsParts = WEBDEV_COURSE_PARTS.filter((p) => p.id === "web-part-3")
  const totalLessons = jsParts.reduce(
      ...
      <section className="relative overflow-hidden py-16 lg:py-24 border-b border-border/80 bg-card">
        <div className="mx-auto max-w-5xl px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 mb-6 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-mono font-medium shadow-2xs">
            ...
            <span>Web Interactivity Track • {totalLessons} Lessons</span>
          </div>
          ...
          <p className="mt-5 max-w-2xl mx-auto text-base sm:text-lg text-muted-foreground leading-relaxed">
            The programming language of the web. Learn variables, arrow functions, click events, and DOM manipulation to create dynamic, interactive websites.
          </p>
