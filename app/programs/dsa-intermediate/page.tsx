...
import { chapterInfo, lessons, courseCurriculum, courseInfo } from "@/lib/dsa-intermediate-course-data"

export default function DSAIntermediateLandingPage() {
    return (
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                        ...
                        <div className="flex-1 text-center lg:text-left">
                            <div className="inline-flex items-center gap-2 px-3.5 py-1 mb-6 rounded-full border border-primary/20 bg-primary/10 text-primary text-xs font-mono font-medium">
                                ...
                                <span>Intermediate Track • {courseInfo.totalLessons} Lessons</span>
                            </div>
                            ...
                            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-normal tracking-tight text-foreground leading-[1.1]">
                                ...
                                <span className="italic">Algorithms</span> Intermediate
                            </h1>
                            ...
                            <div className="mt-8 flex flex-wrap items-center gap-4 justify-center lg:justify-start">
                                <Link
                                    href="/programs/dsa-intermediate/course"
                                ...
                                <span className="text-xs text-muted-foreground">
                                    Free Access • Intermediate Level • No Setup
                                </span>
                            </div>
                        </div>
                            ...
                            <div className="rounded-2xl border border-border/80 bg-card/70 backdrop-blur-xl p-6 shadow-sm">
                                ...
                                <div className="pt-4 border-t border-border">
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        {["Recursion", "Trees", "Binary Search", "Hash Tables", "Two Pointers"].map(tag => (
            ...
            <section className="py-20 lg:py-24 border-b border-border">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mb-14 text-center max-w-2xl mx-auto">
                        <span className="text-xs font-mono uppercase tracking-widest text-primary block mb-3">Structured Curriculum</span>
                        <h2 className="font-serif text-3xl sm:text-4xl text-foreground font-normal tracking-tight">
                            {courseInfo.totalLessons} Lessons across {courseCurriculum[0].chapters.length} Modules
                        </h2>
                        <p className="mt-3 text-sm text-muted-foreground">
                            Deep dive into non-linear data structures, recursive problem decompositions, and time-space trade-offs.
                        </p>
                    </div>
            ...
            <section className="py-20 bg-card/40">
                <div className="mx-auto max-w-3xl px-6 text-center">
                    ...
                    <p className="text-muted-foreground text-sm sm:text-base mb-8 max-w-xl mx-auto leading-relaxed">
                        Transition from naive loops to logarithmic algorithms, balanced trees, and heap properties.
                    </p>
                    <Link
                        href="/programs/dsa-intermediate/course"
