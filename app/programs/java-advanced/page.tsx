...
export default function JavaAdvancedCourseLanding() {
  ...
  const conceptCount = javaAdvancedCourseCurriculum.flatMap(p => p.chapters.flatMap(c => c.concepts)).length
  const missionCount = javaAdvancedCourseCurriculum.flatMap(p => p.chapters.flatMap(c => [...(c.missions || []), ...(c.problems || [])])).length
  const chapters = javaAdvancedCourseCurriculum[0]?.chapters || []
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1 mb-6 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-mono font-medium">
                ...
                <span>Advanced Track • {allLessons.length} Lessons</span>
              </div>

              <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-normal tracking-tight text-foreground leading-[1.1]">
                Java Advanced &amp; <br className="hidden sm:inline" />
                <span className="italic font-serif text-primary">JVM Internals</span> Architecture
              </h1>

              <p className="mt-6 max-w-xl text-base sm:text-lg text-muted-foreground leading-relaxed">
                Master JVM bytecode execution, garbage collection tuning, asynchronous non-blocking I/O, and enterprise distributed patterns.
              </p>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4 justify-center lg:justify-start">
                ...
                <span className="text-xs font-mono text-muted-foreground">
                  High-Throughput Systems • JVM Profiling • Spring Boot Core
                </span>
              </div>
            </div>
              ...
              <div className="rounded-3xl border border-border/80 bg-card/70 backdrop-blur-xl p-6 shadow-sm">
                <div className="flex items-center justify-between pb-5 border-b border-border/70">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-[11px] font-mono text-primary uppercase tracking-wider block font-semibold">Level 3</span>
                      <h3 className="text-sm font-medium text-foreground">JVM &amp; High Scale Systems</h3>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 py-5">
                  {[
                    ...
                    { icon: Zap, label: "XP Total", value: "3,500 XP" },
                ...
                <div className="pt-4 border-t border-border/70">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {["JMM & Memory", "ZGC & G1", "Bytecode & JIT", "Reactive Streams", "CompletableFuture", "Microbenchmarks"].map(tag => (
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-14 text-center max-w-2xl mx-auto">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Deep architectural immersion into JVM memory layouts, concurrent lock-free data structures, and production tuning.
            </p>
          </div>
      ...
      <section className="py-20 bg-card/40">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="font-serif text-3xl lg:text-4xl text-foreground font-normal tracking-tight mb-4">
            Operate at the core of Java performance
          </h2>
          <p className="text-muted-foreground text-sm sm:text-base mb-8 max-w-xl mx-auto leading-relaxed">
            Gain the deep internal intuition required to profile and optimize critical low-latency Java applications.
          </p>
          <Link
            href="/programs/java-advanced/course"
