...
export const metadata = {
  title: "C Programming Course - Learn C Simply | ASCI",
  description: "Learn C programming with simple explanations, interactive examples, and memory visualization. Zero setup required.",
}

export default function CLandingPage() {
  const totalLessons = C_COURSE_PARTS.reduce(
      ...
      <section className="relative overflow-hidden py-16 lg:py-24 border-b border-border/80 bg-card">
        <div className="mx-auto max-w-5xl px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 mb-6 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-mono font-medium shadow-2xs">
            ...
            <span>Foundational Systems • {totalLessons} Lessons</span>
          </div>
          ...
          <p className="mt-5 max-w-2xl mx-auto text-base sm:text-lg text-muted-foreground leading-relaxed">
            Understand how computers actually work. Master C syntax, memory addresses, and pointers through clear, step-by-step interactive lessons without any confusing jargon.
          </p>

          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/programs/c/course"
      ...
      <section className="py-16 max-w-5xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Structured step-by-step from your first line of code to dynamic memory pointers.
          </p>
        </div>

        <div className="space-y-6">
          {C_COURSE_PARTS.map((part) => (
            <div
              key={part.id}
        ...
        <div className="mt-14 p-8 rounded-3xl border border-border/80 bg-card/70 dark:bg-[#181715] text-center max-w-3xl mx-auto shadow-xs">
          ...
          <p className="mt-2 text-xs sm:text-sm text-muted-foreground max-w-md mx-auto">
            Zero installation required. Write, run, and understand C directly in your web browser.
          </p>
          <div className="mt-6">
            <Link
              href="/programs/c/course"
