...
export const metadata = {
  title: "TypeScript Course - Learn TypeScript Simply | ASCI",
  description: "Master modern TypeScript with static types, interfaces, generics, and utility types. Interactive browser lessons with zero setup required.",
}

export default function TypeScriptLandingPage() {
  const totalLessons = TYPESCRIPT_COURSE_PARTS.reduce(
      ...
      <section className="relative overflow-hidden py-16 lg:py-24 border-b border-border/80 bg-card">
        <div className="mx-auto max-w-5xl px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-3.5 py-1 mb-6 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-mono font-medium shadow-2xs">
            <TechLogo slug="typescript" className="h-4 w-4" />
          ...
          <p className="mt-5 max-w-2xl mx-auto text-base sm:text-lg text-muted-foreground leading-relaxed">
            Eliminate runtime bugs and ship scalable code with confidence. Master static typing, interfaces, generics, and utility types through step-by-step interactive lessons.
          </p>

          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/programs/typescript/course"
      ...
      <section className="py-16 lg:py-20 max-w-5xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-sm mt-2">
            Structured step-by-step from fundamental types to advanced conditional type gymnastics.
          </p>
        </div>

        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {TYPESCRIPT_COURSE_PARTS.map((part, pIdx) => (
            <div
              key={part.id}
