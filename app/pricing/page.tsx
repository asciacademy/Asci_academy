            ...
            <div className="max-w-7xl mx-auto px-6 py-16 lg:py-24 w-full flex-1">
                ...
                <section id="pricing-plans" className="mb-20 scroll-mt-24">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {/* Initiate Tier */}
                        <div className="p-8 rounded-3xl bg-card/70 backdrop-blur-xl border border-border/80 flex flex-col justify-between transition-all hover:border-primary/40 shadow-xs">
                        <div>
                    ...
                    <div className="p-8 rounded-3xl bg-card/85 backdrop-blur-xl border-2 border-primary relative flex flex-col justify-between shadow-sm">
