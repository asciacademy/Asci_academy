      ...
      <div className="rounded-2xl border border-hairline bg-card/70 p-6 backdrop-blur-xl shadow-sm">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="rounded-xl border border-indigo-500/20 bg-indigo-500/5 px-4 py-2 text-center">
              <span className="text-[10px] font-mono uppercase tracking-wider text-indigo-600 dark:text-indigo-400 block">Medium</span>
                                ...
                                <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
                                  ...
                                  <span
                                    className={cn(
                                      ...
                                      prob.difficulty === "Medium" && "bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border border-indigo-500/20",
                                  ...
                                  {prob.leetcodeUrl && (
                                    <a
                                      ...
                                      target="_blank"
                                      rel="noopener noreferrer"
                                      className="flex h-7 w-7 items-center justify-center rounded-lg border border-hairline bg-background hover:bg-blue-500/10 hover:border-blue-500/30 hover:text-blue-600 transition-colors text-muted-foreground"
