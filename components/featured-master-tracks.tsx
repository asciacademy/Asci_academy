      ...
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 sm:mb-10">
          ...
          <div className="flex overflow-x-auto no-scrollbar max-w-full -mx-4 px-4 sm:mx-0 sm:px-0">
            <div className="inline-flex items-center gap-1.5 rounded-2xl border border-hairline bg-card/80 p-1.5 backdrop-blur-md shadow-xs shrink-0 text-xs font-mono">
