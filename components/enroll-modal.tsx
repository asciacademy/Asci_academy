              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  ...
                  <button
                    ...
                    className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 rounded-xl bg-primary hover:bg-primary-active px-6 py-2.5 text-xs font-semibold text-primary-foreground transition-all cursor-pointer"
                  >
                    <span>
