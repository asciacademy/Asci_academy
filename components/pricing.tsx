...
const plans = [
  ...
  },
  {
    ...
    priceYearly: "₹1,499",
    period: "/month",
    description: "Full access to all 400+ problems, interactive editor, algorithm animations, and career prep.",
    icon: Layers,
    features: [
      "All 400+ problems & step-by-step solutions",
  ...
  },
  {
    ...
    priceYearly: "₹4,499",
    period: "/month",
    description: "1-on-1 code reviews, live mock interviews, resume reviews, and job referrals.",
    icon: Server,
    features: [
      "Everything in Pro Learner",
      "Weekly 1-on-1 expert code reviews",
      "Live mock interview practice",
      "Direct resume & referral support",
    ],
    cta: "Get Mentorship",
    href: "/pricing",
    highlight: false,
