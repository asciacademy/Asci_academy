      ...
      >
        ...
        <header className="w-full max-w-6xl flex items-center justify-between px-4 sm:px-8 py-3.5 sm:py-4 shrink-0 z-20 print:hidden">
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
            {/* ASCI Signature Blue Accreditation Badge */}
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10.5px] font-mono font-semibold tracking-wider uppercase bg-blue-500/15 text-blue-400 border border-blue-500/35 shadow-xs">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-500" />
              ASCI ACCREDITED
            </span>

            <span className="text-blue-500/40 hidden sm:inline">•</span>

            {/* Serial Pill in ASCI Brand Styling */}
            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-mono tracking-wider font-semibold text-blue-400 bg-blue-500/10 border border-blue-500/25">
        ...
        <main className="flex-1 w-full flex items-center justify-center px-2 sm:px-6 py-1 sm:py-2 overflow-hidden relative print:p-0 print:m-0 print:overflow-visible">
          {/* Certificate Frame with Blue Accent Border and Drop Shadow */}
          <div className="relative z-10 w-full max-w-[min(1080px,calc((100vh-140px)*1.414))] aspect-[1.414/1] shadow-2xl ring-1 ring-blue-500/35 rounded-xs print:shadow-none print:ring-0 print:max-w-none print:w-full print:h-full">
        ...
        <footer className="w-full max-w-6xl flex flex-col items-center gap-2 px-4 sm:px-8 pb-4 sm:pb-5 pt-2 shrink-0 z-20 print:hidden">
          ...
          <div className="flex items-center gap-2 sm:gap-3 p-1.5 sm:p-2 rounded-2xl bg-black/95 border border-hairline backdrop-blur-xl shadow-lg flex-wrap justify-center">
            ...
            >
              {copied ? (
                <>
                  ...
                  <span className="text-blue-400">Copied Link</span>
                </>
              ) : (
                <>
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3.5 sm:px-4 py-2.5 rounded-xl border border-blue-500/35 bg-[#1F1E1B] hover:bg-blue-500/15 text-xs font-mono font-medium text-blue-400 hover:text-blue-300 transition-all"
