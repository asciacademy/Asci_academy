    ...
    <div className="w-[85vw] sm:w-[320px] md:w-[340px] shrink-0 snap-start flex flex-col justify-between overflow-hidden rounded-3xl border border-stone-200/80 dark:border-stone-800/80 bg-card hover:border-amber-500/40 dark:hover:border-amber-500/30 transition-[transform,border-color,box-shadow] duration-200 ease-out hover:-translate-y-0.5 shadow-xs hover:shadow-md will-change-[transform] group">
      <div>
        ...
        <div className="p-5 space-y-2.5">
          {/* Metadata: Credential · Duration · Rating */}
          <div className="flex items-center justify-between text-xs font-mono text-muted-foreground">
            <span className="truncate max-w-[180px]">{course.credential} · {course.duration}</span>
      ...
      {/* Card Action Footer */}
      <div className="p-5 pt-3 flex items-center justify-between border-t border-stone-100 dark:border-stone-800/80 mt-1">
        <span className="text-[11px] font-mono text-muted-foreground truncate max-w-[120px]">
          {course.partner || "ASCI Track"}
        </span>
        ...
        {enrolled ? (
          <div className="flex items-center gap-2">
            ...
            <Link
              href={lessonHref}
              className="inline-flex items-center gap-1 px-3 py-1.5 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white text-xs font-semibold shadow-2xs transition-all active:scale-[0.98] cursor-pointer"
            >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white transition-all text-xs font-semibold cursor-pointer shadow-2xs active:scale-[0.98]"
            >
            ...
            <Link
              href={href}
              className="text-xs text-muted-foreground hover:text-foreground inline-flex items-center gap-1 active:scale-[0.98] transition-colors"
            >
              <span>Explore</span>
