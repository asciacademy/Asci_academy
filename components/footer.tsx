...
const footerColumns = [
  {
    ...
    links: [
      ...
      { label: "Practice DSA Arena", href: "/dsa" },
      { label: "Projects Hub", href: "/projects" },
      { label: "Interactive Sandboxes", href: "/sandbox" },
    ],
  },
  {
    heading: "Career",
    links: [
      { label: "Software Engineering Jobs", href: "/career?tab=jobs" },
      { label: "Student Internships", href: "/career?tab=internships" },
      { label: "National Hackathons", href: "/career?tab=hackathons" },
      { label: "1-on-1 Mentorship", href: "/career?tab=mentorship" },
      { label: "Resume ATS Scanner", href: "/career?tab=resume" },
    ],
  },
  {
    heading: "Resources",
    links: [
      ...
      { label: "Verified Certificates", href: "/certificates" },
      { label: "Discord Server", href: "https://discord.com", external: true },
      { label: "GitHub Repositories", href: "https://github.com", external: true },
    ],
  },
  {
    heading: "Company",
    links: [
      { label: "About ASCI", href: "/programs" },
