          ...
          <div className="flex items-center justify-between pb-3 border-b border-hairline mb-4">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-mono font-semibold px-2.5 py-1 rounded-full bg-amber-500/10 hover:bg-amber-500/20 text-amber-500 border border-amber-500/30 transition-all cursor-pointer active:scale-95 group"
                title="View Streak Badges & Multipliers"
              >
                <Flame className="h-3.5 w-3.5 fill-amber-500 text-amber-500 group-hover:scale-110 transition-transform" />
              ...
              {weekDays.map((day, idx) => (
                <div
                  ...
                  className={`flex flex-col items-center justify-center py-1.5 px-0.5 rounded-lg transition-all text-center ${
                    day.isToday
                      ? "bg-amber-500/15 border border-amber-500/40 shadow-xs"
                      : day.isActive
        ...
        {showStreakModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md">
            <motion.div
              ...
              className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-3xl bg-[#0c1810] border border-[#D4B872]/30 shadow-2xl p-6 text-[#FDFBF7]"
            >
              {/* Top Accent Line */}
              ...
              <button
                ...
                className="absolute top-5 right-5 h-8 w-8 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white/70 hover:text-white transition-colors cursor-pointer"
              >
                <X className="h-4 w-4" />
              </button>
              ...
              <div className="p-4 rounded-2xl bg-card border border-border mb-6">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
                  <div className="p-3 rounded-xl bg-black/30 border border-white/5">
                    <span className="text-[10px] font-mono text-white/60 uppercase block mb-1">
                      Current Streak
                    </span>
                    <span className="font-mono text-2xl font-bold text-amber-400">
                      {streakCount} <span className="text-xs font-normal text-white/60">Days</span>
                    </span>
                  </div>
                  ...
                  <div className="p-3 rounded-xl bg-black/30 border border-white/5">
                    ...
                    <span className="font-mono text-2xl font-bold text-[#D4B872]">
                  ...
                  <div className="p-3 rounded-xl bg-black/30 border border-white/5">
                    ...
                    <span className="font-mono text-2xl font-bold text-emerald-400">
                      ...
                      <span className="text-xs font-normal text-white/60">XP/d</span>
                    </span>
                  </div>
                  ...
                  <div className="p-3 rounded-xl bg-black/30 border border-white/5">
                    ...
                    <span className="font-mono text-2xl font-bold text-sky-400">
                      {nextTargetDays} <span className="text-xs font-normal text-white/60">Days</span>
                    </span>
                  </div>
                </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10">
                    <div className="flex items-center justify-between text-xs mb-1.5">
                      <span className="text-white/80 font-medium flex items-center gap-1.5">
                        <Trophy className="h-3.5 w-3.5 text-[#D4B872]" />
                        <span>Next Milestone: {nextMilestoneBadge.title}</span>
                      </span>
                      <span className="font-mono text-[#D4B872] font-semibold">
                    ...
                    <div className="h-2 w-full bg-black/40 rounded-full overflow-hidden border border-white/10">
                      <div
                        className="h-full bg-[#D4B872] rounded-full transition-all duration-500"
                        style={{
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="font-serif text-base text-[#FDFBF7]">
                    ...
                    return (
                      <div
                        ...
                        className={`p-3 rounded-2xl border transition-all flex items-center gap-3.5 ${
                          isUnlocked
                            ? "bg-emerald-950/40 border-[#D4B872]/40 shadow-sm"
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2 mb-0.5">
                            <h5 className="font-serif text-sm font-medium text-[#FDFBF7] truncate">
                              {badge.title}
                            </h5>
                            <span
                          ...
                          <p className="text-[11px] text-white/70 line-clamp-1 mb-1">
                            {badge.description}
                          </p>
                          <div className="flex items-center justify-between text-[10px] font-mono">
                            <span className="text-amber-400">+{badge.xpReward} XP</span>
                            <span className={isUnlocked ? "text-emerald-400 font-semibold" : "text-white/40"}>
