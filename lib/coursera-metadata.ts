...
export const COURSERA_PARTNERS: Record<string, { name: string; type: string; color: string }> = {
  ...
  "asci": { name: "ASCI Institute of Technology", type: "Accredited Academy", color: "#2563eb" },
  "anthropic": { name: "Anthropic Claude Academy", type: "AI Safety & Research", color: "#2563eb" },
